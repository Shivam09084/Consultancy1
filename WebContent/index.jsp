...
<div class="container " >
<h3>We Provide Medical Services</h3>
<h3>That You Can Trust!</h3>
<p>Consulting with a doctor can provide insight into your health and wellness. Seeking expert advice can prevent serious illness. Regular check-ups and screenings are essential for maintaining good health.</p>
<a href="registeration.jsp" class="btn btn-outline btn-lg "><span class="fa fa-user-plus" ></span>SignUp !</a>
<a href="login.jsp" class="btn btn-outline btn-lg "><span class="fa fa-user "></span>LogIn</a>
</div>
</div>
</div>
<!--section1-->
...
<div class="card-deck">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <a href="registeration.jsp" class="btn btn-primary">Go somewhere</a>
